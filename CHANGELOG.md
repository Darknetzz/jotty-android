...
- **Checklist drag gesture stability** — Dragging checklist items no longer stops after the first position change; reorder sync is now sent when the drag ends so one gesture can move across multiple rows.
