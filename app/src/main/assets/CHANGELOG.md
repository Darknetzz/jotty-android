...
- **Checklist list not tappable** — Pull-to-refresh nested scroll is wired correctly and resets after refresh; checklist cards use a single click target (no nested click handlers); offline repo/UI ViewModels use separate store keys.
